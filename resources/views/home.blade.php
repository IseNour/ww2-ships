...
<div class="text-center mb-5">
    <h1 class="text-4xl md:text-6xl font-bold font-cinzel" style="background: linear-gradient(135deg, #ccb250 0%, #e5d79eff 50%, #ccb250 100%); -webkit-background-clip: text; -webkit-text-fill-color: transparent; background-clip: text;">
        ⚓ Encyclopedia of Warships
    </h1>
    <p class="text-xl mt-3 font-light tracking-wide" style="color: var(--text-primary, #1a3a5c);">
        The Ultimate World War II Naval Vessel Database
    </p>
    <div class="flex flex-wrap justify-center gap-3 mt-4">
    <span class="bg-gradient-to-r from-navy-500 to-ocean-500 text-white px-4 py-2 rounded-full text-sm font-medium" style="color: #c9a84c !important;">
        <i class="bi bi-ship"></i> {{ $totalShips }} Ships
    </span>
    <span class="bg-gradient-to-r from-navy-500 to-ocean-500 text-white px-4 py-2 rounded-full text-sm font-medium" style="color: #c9a84c !important;">
        <i class="bi bi-airplane"></i> {{ $carriers }} Carriers
    </span>
    <span class="bg-gradient-to-r from-brass-500 to-brass-600 text-white px-4 py-2 rounded-full text-sm font-medium" style="color: #c9a84c !important;">
    ...
    <div class="h-0.5 w-4/5 mx-auto my-5 rounded-full" style="background: linear-gradient(90deg, transparent, var(--text-primary, #1a3a5c), #2e89a8, var(--text-primary, #1a3a5c), transparent);"></div>
</div>
...
@endif
   ...
   style="background: var(--btn-bg, rgba(255,255,255,0.95)); color: var(--btn-text, #1a3a5c); border: 1px solid var(--border-color, rgba(26,58,92,0.1)); border-radius: 12px; transition: all 0.3s ease; box-shadow: 0 4px 15px rgba(0,0,0,0.2);">
...
<div class="row mb-5">
    <div class="col-md-12">
        <div class="card shadow-sm border-0" style="background: var(--bg-card, rgba(255,255,255,0.95)); backdrop-filter: blur(10px); border-radius: 16px; transition: background 0.3s ease;">
            <div class="card-body p-5">
                <h2 class="text-center mb-4" style="font-family: 'Cinzel', serif; color: var(--text-primary, #1a3a5c);">⚓ Warships of World War II</h2>
                <div class="row">
                    <div class="col-md-8 mx-auto">
                        <p class="lead text-center" style="color: var(--text-primary, #1a3a5c);">
                ...
                <div class="row mt-4 g-4">
                    <div class="col-md-3 text-center">
                        <div class="p-3 rounded-3" style="background: rgba(26, 58, 92, 0.05);">
                            <i class="bi bi-ship display-4" style="color: var(--text-primary, #1a3a5c);"></i>
                            <h5 class="mt-2" style="color: var(--text-primary, #1a3a5c); font-weight: 600;">Battleships</h5>
                    ...
                    <div class="col-md-3 text-center">
                        <div class="p-3 rounded-3" style="background: rgba(46, 137, 168, 0.05);">
                            ...
                            <h5 class="mt-2" style="color: var(--text-primary, #1a3a5c); font-weight: 600;">Aircraft Carriers</h5>
                            <p class="text-muted small">The new queens of the sea</p>
                        </div>
                    </div>
                    <div class="col-md-3 text-center">
                        <div class="p-3 rounded-3" style="background: rgba(118, 130, 136, 0.05);">
                            <i class="bi bi-water display-4" style="color: var(--text-secondary, #5e6b72);"></i>
                            <h5 class="mt-2" style="color: var(--text-primary, #1a3a5c); font-weight: 600;">Submarines</h5>
                    ...
                    <div class="col-md-3 text-center">
                        <div class="p-3 rounded-3" style="background: rgba(204, 178, 80, 0.05);">
                            ...
                            <h5 class="mt-2" style="color: var(--text-primary, #1a3a5c); font-weight: 600;">Historic Battles</h5>
                ...
                <div class="row mt-4">
                    <div class="col-md-10 mx-auto">
                        <p class="text-center text-muted" style="color: var(--text-secondary, #5e6b72);">
...
<div class="row mb-5 g-3">
    <div class="col-md-3">
        <div class="card text-center shadow-sm border-0" style="background: linear-gradient(135deg, #1a3a5c 0%, #0e263a 100%); border-radius: 16px;">
            <div class="card-body p-4">
                ...
                <p class="lead" style="font-size: 1rem; font-weight: 500; letter-spacing: 1px; color: #ccb250;">Total Ships</p>
            </div>
        </div>
    </div>
    <div class="col-md-3">
        <div class="card text-center shadow-sm border-0" style="background: linear-gradient(135deg, #2e89a8 0%, #1a3a5c 100%); border-radius: 16px;">
            <div class="card-body p-4">
                ...
                <p class="lead" style="font-size: 1rem; font-weight: 500; letter-spacing: 1px; color: #ccb250;">Aircraft Carriers</p>
            </div>
        </div>
    </div>
    <div class="col-md-3">
        <div class="card text-center shadow-sm border-0" style="background: linear-gradient(135deg, #ccb250 0%, #8a782e 100%); border-radius: 16px;">
            <div class="card-body p-4">
                ...
                <p class="lead" style="font-size: 1rem; font-weight: 500; letter-spacing: 1px; color: #ccb250;">Battles</p>
            </div>
        </div>
    </div>
    <div class="col-md-3">
        <div class="card text-center shadow-sm border-0" style="background: linear-gradient(135deg, #1a3a5c 0%, #0e263a 100%); border-radius: 16px;">
            <div class="card-body p-4">
                ...
                <p class="lead" style="font-size: 1rem; font-weight: 500; letter-spacing: 1px; color: #ccb250;">Countries</p>
            </div>
        </div>
    </div>
</div>
...
<div class="row mb-4">
    <div class="col-md-12">
        <h3 class="mb-3" style="font-family: 'Cinzel', serif; color: var(--text-primary, #1a3a5c);">📜 Recent Battles</h3>
        <div class="row">
            @foreach($recentBattles as $battle)
                <div class="col-md-3 mb-3">
                    <div class="card shadow-sm h-100 border-0" style="background: var(--bg-card, rgba(255,255,255,0.95)); backdrop-filter: blur(10px); border-radius: 12px; transition: all 0.3s ease;">
                        <div class="card-body">
                            <h5 class="card-title" style="color: var(--text-primary, #1a3a5c); font-weight: 600;">{{ $battle->name }}</h5>
                            <p class="card-text">
                                <small class="text-muted" style="color: var(--text-secondary, #5e6b72);">
                                    <i class="bi bi-calendar" style="color: var(--text-primary, #1a3a5c);"></i> {{ $battle->battle_date->format('F d, Y') }}<br>
                                    <i class="bi bi-geo-alt" style="color: var(--text-primary, #1a3a5c);"></i> {{ $battle->battle_site }}
                                </small>
                            </p>
                            <p class="card-text" style="color: var(--text-secondary, #5e6b72);">{{ Str::limit($battle->description, 80) }}</p>
                            <a href="{{ route('battles.show', $battle) }}" class="btn btn-sm" style="background: linear-gradient(135deg, #1a3a5c 0%, #2e89a8 100%); color: white; border: none; border-radius: 8px; transition: all 0.3s ease;">
                                View Battle
                            </a>
                        </div>
                    </div>
...
<style>
    ...
    .card:hover {
        ...
        box-shadow: 0 8px 40px var(--shadow-color, rgba(26,58,92,0.15)) !important;
    }
    ...
    /* Dark mode divider */
    [data-bs-theme="dark"] .h-0.5 {
        background: linear-gradient(90deg, transparent, #ccd6e0, #2e89a8, #ccd6e0, transparent) !important;
    }
</style>
@endsection